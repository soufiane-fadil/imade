...
export default function HomePage() {
  ...
  return (
    <div className="mc-root">
      ...
      >
        ...
        >
          <div>
            ...
            <h1
              className="h-display"
              style={{ fontSize: 64, margin: 0, maxWidth: 720 }}
            >
              {a[0].title}
            </h1>
            <p
      ...
      >
        ...
        >
          <div>
            ...
            <h2
              className="h-display"
              style={{ fontSize: 56, margin: "10px 0 0" }}
            >
              Le QCM{" "}
              <span style={{ color: "var(--signal)" }}>Maison Calorie</span>.
              <br />
              ...
              {["A · 2,8", "B · 3,2", "C · 3,5", "D · 3,8"].map((o, i) => (
                <div
                  ...
                  style={{
                    ...
                    color: i === 2 ? "var(--signal)" : "var(--paper)",
                  }}
                >
                  {o}
                  {i === 2 ? " ◉" : ""}
      ...
      >
        ...
        >
          ...
          >
            ...
            <Link
              ...
              className="mono lnk"
              style={{ fontSize: 10, borderBottom: 0, color: "var(--ink)" }}
            >
        ...
        >
          ...
          >
            ...
            <div
              style={{ fontSize: 12, color: "var(--paper-3)", marginTop: 6 }}
            >
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <h2
              className="h-title"
              style={{ fontSize: 44, marginTop: 12, maxWidth: 560 }}
            >
      ...
      <section
        style={{ padding: "36px 28px", borderBottom: "1px solid var(--ink)" }}
      >
        <div className="h-section" style={{ marginBottom: 16 }}>
          —— Naviguer par rubrique
        </div>
        <div
          style={{
            display: "grid",
        ...
        >
          <div>
            ...
            <div className="h-title" style={{ fontSize: 32, marginTop: 6 }}>
              ...
              <span style={{ color: "var(--signal)" }}>4,8 / 5</span>
            </div>
          </div>
          <div
            className="mono"
        ...
        >
          {TESTIMONIALS.map((t) => (
            ...
            >
              ...
              <div
                className="mono"
                style={{ fontSize: 22, color: "var(--signal)", lineHeight: 1 }}
              >
                “
              </div>
              <blockquote
